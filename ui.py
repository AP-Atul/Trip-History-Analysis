...
class App(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Trip History Analysis')
    ...
    def initUI(self):
        ...
        # csv label
        csvInfoLabel = QLabel()
        csvInfoLabel.setText("Capital Bikeshare Dataset")
        ...
        fileInfoLabel.setText("2018_01_02_preprocessed.csv")
        ...
        datasetInfo = QLabel()
        datasetInfo.setText("350969 Rows")
